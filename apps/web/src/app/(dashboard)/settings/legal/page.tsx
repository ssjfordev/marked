...
export default async function LegalPage() {
  ...
  const legalLinks = [
    ...
    },
    {
      ...
      description: t('legal.cookiesDesc'),
      href: '/legal/cookies',
      icon: (
        <svg
          className="w-5 h-5"
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-xl border border-border bg-surface p-6">
        <h2 className="text-lg font-semibold text-foreground mb-4">{t('legal.title')}</h2>
        <div className="space-y-3">
          {legalLinks.map((item) => (
            ...
            >
              ...
              <svg
                className="w-5 h-5 text-foreground-faint flex-shrink-0"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth={2}
      ...
      <div className="rounded-xl border border-border bg-surface p-6">
        <h2 className="text-lg font-semibold text-foreground mb-4">{t('legal.contact')}</h2>
        <p className="text-sm text-foreground-muted mb-4">{t('legal.contactDesc')}</p>
        <a
