    ...
    <div className="space-y-8">
      ...
      <section>
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-medium text-foreground">{t('dashboard.recentLinks')}</h2>
        </div>
        ...
        {recentLinks.length > 0 ? (
          ...
          <div className="rounded-xl border border-border bg-surface p-8 text-center">
            <p className="text-foreground-muted">{t('dashboard.noRecentLinks')}</p>
          </div>
        )}
      </section>
      ...
      <section>
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-medium text-foreground">{t('dashboard.favorites')}</h2>
          </div>
          <Link
            href="/favorites"
        ...
        {favoriteLinks.length > 0 ? (
          ...
          <div className="rounded-xl border border-border bg-surface p-8 text-center">
            ...
            <p className="text-foreground-muted">{t('dashboard.noFavorites')}</p>
